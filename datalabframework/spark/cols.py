...
from datalabframework.spark import utils
from datalabframework.spark import functions
...
class Cols:
    ...
    @property
    def rows(self):
        from datalabframework.spark.rows import Rows
        return Rows(self.df, self.scols, self.gcols)

    @property
    def data(self):
        from datalabframework.spark.data import Data
