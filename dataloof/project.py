...
from dataloof import __version__
...
#utils
from dataloof.yaml import YamlDict
from dataloof._utils import Singleton, repo_data, to_ordered_dict, python_version, relpath, abspath
    ...
    def info(self):
        if not self.loaded:
            logging.error(
                ...
                "Execute dataloof.project.load(...) first.")
            return None
