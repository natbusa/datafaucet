...
from dataloof.spark import aggregations as A
from dataloof.spark import utils
from dataloof.spark import functions
...
class Cols:
    ...
    @property
    def rows(self):
        from dataloof.spark.rows import Rows
        return Rows(self.df, self.scols, self.gcols)

    @property
    def data(self):
        from dataloof.spark.data import Data
